...
stopwords.append('원')
stopwords.append('영상')
stopwords+=['LG','틔운','I','AND','YOU','YOURS','VIDEOS','FOR','AT','TO','BY','ALWAYS','SOME','THING','가전']
stopwords+=['잇섭','섭','잇','유투버','후기','얼굴','형','한남','생각','식물','페미','만','주연']
stopwords+=['그램','엘지','엘쥐','중','오빠','신동','엠알','모델','점','정도','때문','노트북','인치']
